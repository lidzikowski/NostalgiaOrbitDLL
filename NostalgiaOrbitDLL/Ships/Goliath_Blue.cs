...
{
    [Serializable]
    public class Goliath_Blue : AbstractShip
    {
        public static Goliath_Blue Instance { get; } = new Goliath_Blue();
        public Goliath_Blue()
        {
            ShipType = PrefabTypes.goliath_blue_type;
            ...
            CanBuyUridium = true;
            UridiumPurchase = new List<int>(800000);
