...
{
    [Serializable]
    public class BigBoy_Red : AbstractShip
    {
        public static BigBoy_Red Instance { get; } = new BigBoy_Red();
        public BigBoy_Red()
        {
            ShipType = PrefabTypes.bigboy_red_type;
            ...
            CanBuyByCredit = true;
            CreditPurchase = new List<int>(200000);
